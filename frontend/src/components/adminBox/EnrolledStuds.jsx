      ...
      <tbody className='text-sm text-gray-700'>
        {inProgressStudents.map((student,index) => (
          <tr key={index}>
            ...
            <td className="p-4 border-b">{student.course.hasPaid?<span className=' font-semibold'>Paid</span>:<span className='text-red font-semibold'>Pending<button className='mt-1 text-white bg-blue text-[8px] px-1'>Mark Paid</button></span>}</td>
