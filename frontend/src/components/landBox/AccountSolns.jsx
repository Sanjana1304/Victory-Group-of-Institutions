  ...
  return (
    <div className='max-h-[500px] overflow-y-scroll'>
      {courses.map((course,index) => {
        return <CourseBox key={index} coursename={course} courseCat={'Business & Accounting Solutions'} imgg="/images/accounts.jpg" desc={descriptions[index]} enroll={enroll} fees={fees[index]}/>
      })}
    </div>
  )
}
